...
public class EvalSegmentJEP1 {
    @Param({"100", "1000", "10000", "100000"})
    private int size;

    private List<JepExpr> setgmentExprs;

    @Setup
    public void setup() throws JepException {
        setgmentExprs = new ArrayList<JepExpr>(size);
        for (int i = 0; i < size; i++) {
            ...
            setgmentExprs.add(expr);
        }
    }

    // Cache many Jep objects and parsed nodes. (original one)
    @Benchmark
...
EvalSegmentJEP1.evalJep     100  avgt    3  ≈ 10⁻⁴            s/op
EvalSegmentJEP1.evalJep    1000  avgt    3   0.001 ±  0.001   s/op
EvalSegmentJEP1.evalJep   10000  avgt    3   0.038 ±  0.008   s/op
EvalSegmentJEP1.evalJep  100000  avgt    3   0.378 ±  0.038   s/op
*/
